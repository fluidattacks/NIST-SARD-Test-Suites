...
Filename: CWE80_XSS__Web_Listen_tcp_22a.cs
...
{
class CWE80_XSS__Web_Listen_tcp_22a : AbstractTestCaseWeb
{
    ...
    public override void Bad(HttpRequest req, HttpResponse resp)
    {
        ...
        data = CWE80_XSS__Web_Listen_tcp_22b.BadSource(req, resp);
        if (data != null)
        {
    ...
    private void GoodG2B1(HttpRequest req, HttpResponse resp)
    {
        ...
        data = CWE80_XSS__Web_Listen_tcp_22b.GoodG2B1Source(req, resp);
        if (data != null)
        {
            /* POTENTIAL FLAW: Display of data in web page without any encoding or validation */
            resp.Write("<br>Bad(): data = " + data);
    ...
    private void GoodG2B2(HttpRequest req, HttpResponse resp)
    {
        ...
        data = CWE80_XSS__Web_Listen_tcp_22b.GoodG2B2Source(req, resp);
        if (data != null)
        {
            /* POTENTIAL FLAW: Display of data in web page without any encoding or validation */
            resp.Write("<br>Bad(): data = " + data);
